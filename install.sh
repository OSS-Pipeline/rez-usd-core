...
echo -e "[INSTALL][ARGS] USD-CORE VERSION: ${USD_CORE_VERSION}"

# We check if the arguments variables we need are correctly set.
# If not, we abort the process.
if [[ -z ${BUILD_PATH} || -z ${INSTALL_PATH} || -z ${USD_CORE_VERSION} ]]; then
    echo -e "\n"
...
# We install USD-Core.
echo -e "\n"
echo -e "[INSTALL] Installing USD-Core-${USD_CORE_VERSION}..."
echo -e "\n"
...
echo -e "\n"
echo -e "[INSTALL] Finished installing USD-Core-${USD_CORE_VERSION}!"
echo -e "\n"
